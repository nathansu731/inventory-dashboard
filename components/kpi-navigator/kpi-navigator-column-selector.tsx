...
type KpiNavigatorColumnSelectorProps = {
...
export const KpiNavigatorColumnSelector = ({setIsColumnModalOpen, columnVisibility, setColumnVisibility}: KpiNavigatorColumnSelectorProps) => {
